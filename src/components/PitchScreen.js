...
function ItIsImportant() {
    ...
    urlMap.set('https://www.nytimes.com/2016/02/28/magazine/what-google-learned-from-its-quest-to-build-the-perfect-team.html', 'a nytimes article');
    urlMap.set('https://rework.withgoogle.com/blog/how-to-foster-psychological-safety/', 're:Work');
    urlMap.set('https://youarenotsosmart.com/2017/10/01/yanss-111-some-groups-are-smarter-than-others-and-psychologists-want-to-understand-why/', 'YANSS #111');
    ...
    return <View>
        ...
        <Hyperlink
            ...
            <Paragraph>
                According to
                https://www.nytimes.com/2016/02/28/magazine/what-google-learned-from-its-quest-to-build-the-perfect-team.html, Google found social intelligence to be the primary indicator to psycological safety.
            </Paragraph>
            <Paragraph>
                "All team members can actively shape a team’s norm." - https://rework.withgoogle.com/blog/how-to-foster-psychological-safety/
            </Paragraph>
            <Paragraph>
